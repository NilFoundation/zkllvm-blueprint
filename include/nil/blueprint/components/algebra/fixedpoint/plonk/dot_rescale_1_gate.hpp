        ...
        namespace components {
            ...
            public:
                ...
                struct var_positions {
                    CellPosition dot_c_0, dot_p_0, dot_result;
                ...
                var_positions get_var_pos(const int64_t start_row_index) const {
                    ...
                    // trace layout (2*b + 2 col(s), a + c row(s))
                    // dot_c .. running sum of the dot product incl. current row
                    // dot_p .. running sum of the dot product incl. previous row excl. current row
                    ...
                    //
                    // dot_p_n = dot_c_n-1 (e.g. dot_p_1 = dot_c_0)
                    // dot_p_0 = 0
                    //
                    // dot_c_n = dot_p_n + sum_i x_n_i * y_n_i for i in [0, b-1], for n in [0, a-1]
                    //
                    ...
                    //
                    //     |                                         witness                                          |
                    //  r\c|     0     |     1     |    2    |    3    |    4    |    5    |..|   2 * b   | 2 * b + 1 |
                    // +---+-----------+-----------+---------+---------+---------+---------+--+-----------+-----------+
                    // | 0 |  dot_c_0  |  dot_p_0  | x_0_0   | y_0_0   | x_0_1   | y_0_1   |..|  x_0_b-1  |  y_0_b-1  |
                    // | 1 |  dot_c_1  |  dot_p_1  | x_1_0   | y_1_0   | x_1_1   | y_1_1   |..|  x_1_b-1  |  y_1_b-1  |
                    // |.. |    ..     |    ..     |   ..    |   ..    |   ..    |   ..    |..|    ..     |    ..     |
                    // |a-1| dot_c_a-1 | dot_p_a-1 | x_a-1_0 | y_a-1_0 | x_a-1_1 | y_a-1_1 |..| x_a-1_b-1 | y_a-1_b-1 |
                    // | a | <rescale_witness>                                                                        |
                    ...
                    pos.dot_c_0 = CellPosition(this->W(0), start_row_index);
                    pos.dot_p_0 = CellPosition(this->W(1), start_row_index);
                    pos.dot_result = CellPosition(this->W(0), pos.rescale_row - 1);    // is dot_c_a-1
                    return pos;
                }
            ...
            typename plonk_fixedpoint_dot_rescale_1_gate<BlueprintFieldType, ArithmetizationParams>::var get_copy_var(
                ...
                return var(component.W(pos.second), pos.first, false);
            }
            ...
            typename plonk_fixedpoint_dot_rescale_1_gate<BlueprintFieldType, ArithmetizationParams>::result_type
                ...
                for (auto row = 0; row < var_pos.dot_rows_amount; row++) {
                    assignment.witness(var_pos.dot_p_0.column(), var_pos.dot_p_0.row() + row) = sum;
                    ...
                    assignment.witness(var_pos.dot_c_0.column(), var_pos.dot_c_0.row() + row) = sum;
                }
            ...
            typename plonk_fixedpoint_dot_rescale_1_gate<BlueprintFieldType, ArithmetizationParams>::result_type
                ...
                assignment.enable_selector(selector_index, start_row_index, var_pos.rescale_row - 1);
