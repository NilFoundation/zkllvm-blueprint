#ifndef CRYPTO3_BLUEPRINT_PLONK_FIXEDPOINT_ACOSH_HPP
#define CRYPTO3_BLUEPRINT_PLONK_FIXEDPOINT_ACOSH_HPP
        ...
        namespace components {
            ...
            private:
                ...
                hyperbol_sqrt_component instantiate_asinh_sqrt(uint8_t m1, uint8_t m2) const {
                    ...
                    return hyperbol_sqrt_component(witness_list, std::array<std::uint32_t, 1>({this->C(0)}),
                                                   ...
                                                   hyperbol_sqrt_component::hyperbolic_type::ACOSH);
                }
            ...
            public:
                ...
                struct result_type {
                    ...
                    result_type(const fix_acosh &component, std::uint32_t start_row_index) {
                    ...
                    result_type(const fix_acosh &component, std::size_t start_row_index) {
                        const auto var_pos = component.get_var_pos(static_cast<int64_t>(start_row_index));
                        typename hyperbol_log_component::result_type log_res(component.get_hyperbol_log_component(),
                                                                             static_cast<std::size_t>(var_pos.log_row));
                        output = log_res.output;
...
#endif    // CRYPTO3_BLUEPRINT_PLONK_FIXEDPOINT_ACOSH_HPP
